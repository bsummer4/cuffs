...
bool
valid_client_address (int index)
{
  return index >= 0 && index < MAX_CLIENTS;
}

bool
valid_group_address (int index)
{
...
void
update_last_used_client (int what_changed, int index)
{
  switch (what_changed)
    {
    case NEW_CLIENT:
...
void
announce (SBMessage * admin_message)
{
